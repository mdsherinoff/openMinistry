...
const STATUS_COLORS: Record<string, string> = {
  ...
  mining: "bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/30",
  mined: "bg-accent-soft text-accent-soft-fg border-accent-border",
  mining_failed:
    "bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/30",
  rejected: "bg-surface-2 text-muted border-border",
};
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-foreground">Article Queue</h1>
        ...
        <div className="flex items-center gap-2">
                ...
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 border border-border
                      text-muted px-3 py-1.5 rounded-lg text-sm font-medium
                      hover:bg-surface-2 hover:text-foreground disabled:opacity-50"
                  >
                    <XCircle size={14} />
          ...
          <button
            ...
            className="flex items-center gap-1.5 border border-border
              text-muted px-3 py-1.5 rounded-lg text-sm
      ...
      {isLoading ? (
          ...
          {[...Array(5)].map((_, i) => (
            <div
              ...
              className="border border-border rounded-xl p-4
                animate-pulse bg-surface shadow-sm"
            >
        ...
        >
          <FileText size={36} className="text-muted-2 mx-auto mb-3" />
          <p className="text-foreground font-medium">No items in this queue</p>
          <p className="text-muted text-sm mt-1">
        ...
        <div className="flex items-center justify-between gap-3 mt-5 text-sm">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page === 0}
              className="flex items-center gap-1.5 border border-border
                text-foreground px-3 py-1.5 rounded-lg font-medium
  ...
  return (
    <div className="flex items-center gap-2 text-muted">
      ...
      <input
        ...
        className="w-20 border border-border bg-surface text-foreground rounded-lg px-2 py-1
          focus:outline-none focus:border-accent"
      />
      <button
        onClick={commit}
        className="border border-border text-foreground rounded-lg px-3 py-1
...
function QueueItemCard({
  ...
  return (
    <div
      className={cn(
        "border rounded-xl p-4 bg-surface shadow-sm transition-all",
        isSelected
        ...
        {canSelect && (
          <input
            ...
            className="mt-1 rounded border-border
              text-accent focus:ring-accent accent-[var(--accent)]"
          />
        )}
          ...
          <div className="flex items-start justify-between gap-3 mb-1">
            ...
            <span
              className={cn(
                ...
                STATUS_COLORS[item.status] || "bg-surface-2 text-muted",
              )}
            >
          ...
          <div className="flex items-center gap-2">
            {isPending && (
              <>
                <button
                  ...
                  className="flex items-center gap-1.5 bg-accent
                    text-accent-contrast px-3 py-1.5 rounded-lg text-xs
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 border
                    border-border text-muted px-3 py-1.5
                    rounded-lg text-xs font-medium hover:bg-surface-2 hover:text-foreground"
                >
                  <XCircle size={12} />
                  Reject
                </button>
            ...
            {canDelete && (
              <button
                ...
                className="flex items-center gap-1.5 border border-danger-border
                  text-danger px-3 py-1.5 rounded-lg text-xs font-medium
                  hover:bg-danger/10 disabled:opacity-50"
              >
                {isDeleteLoading ? (
                  <Loader2 size={12} className="animate-spin" />
